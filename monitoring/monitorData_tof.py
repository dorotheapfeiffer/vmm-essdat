...
try:
	...
	while True:
		...
		if lastFileId == fileId:
			...
			t.sleep(2)
			continue
		args_vmmsdat = ['../build/convertFile', '-f', "./" + name, '-vmm', '[ [0,0,0,2],[0,0,0,3],[0,0,0,0],[0,0,0,1],[0,1,0,6],[0,1,0,7],[0,1,0,4],[0,1,0,5]]', '-axis', '[[0,0],1],[[0,1],1]', '-bc', '44.02', '-tac', '60', '-th','[0]', '-cs','[1]', '-ccs', '[2]', '-dt', '[200]', '-mst', '[1]', '-spc', '[500]', '-dp', '[500]', '-coin', 'center-of-masss', '-crl', '[0.1]', '-cru', '[10]','-save', '[[0],[0],[0]]', '-json','0', '-algo', '7', '-info', 'n_TOF', '-df', 'ESS']
